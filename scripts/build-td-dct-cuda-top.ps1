...
$sourceDir = Join-Path $root 'touchdesigner\DatamoshDctCudaTOP'
$cppSource = Join-Path $sourceDir 'DatamoshDctCudaTOP.cpp'
$cudaSource = Join-Path $sourceDir 'DatamoshDctCudaKernels.cu'
$outputDir = Join-Path $root 'target\release'
$output = Join-Path $outputDir 'DatamoshDctCudaTOP.dll'
$cppObject = Join-Path $outputDir 'DatamoshDctCudaTOP.obj'
$cudaObject = Join-Path $outputDir 'DatamoshDctCudaKernels.obj'
$pdb = Join-Path $outputDir 'DatamoshDctCudaTOP.pdb'
$cppRsp = Join-Path $outputDir 'DatamoshDctCudaTOP.cl.rsp'
$cudaRsp = Join-Path $outputDir 'DatamoshDctCudaTOP.nvcc.rsp'
$linkRsp = Join-Path $outputDir 'DatamoshDctCudaTOP.link.rsp'
