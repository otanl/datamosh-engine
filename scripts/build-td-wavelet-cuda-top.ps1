...
$cppSource = Join-Path $sourceDir 'DatamoshWaveletCudaTOP.cpp'
$cudaSource = Join-Path $sourceDir 'DatamoshWaveletCudaKernels.cu'
$outputDir = Join-Path $root 'target\release'
$output = Join-Path $outputDir 'DatamoshWaveletCudaTOP.dll'
$cppObject = Join-Path $outputDir 'DatamoshWaveletCudaTOP.obj'
$cudaObject = Join-Path $outputDir 'DatamoshWaveletCudaKernels.obj'
$pdb = Join-Path $outputDir 'DatamoshWaveletCudaTOP.pdb'
$cppRsp = Join-Path $outputDir 'DatamoshWaveletCudaTOP.cl.rsp'
$cudaRsp = Join-Path $outputDir 'DatamoshWaveletCudaTOP.nvcc.rsp'
$linkRsp = Join-Path $outputDir 'DatamoshWaveletCudaTOP.link.rsp'
